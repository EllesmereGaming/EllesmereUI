...
local function Skin_Guild()
    ...
    -- MemberList and its ScrollBox receive secret member data during Blizzard's
    -- refresh. Do not change their geometry, iterate their pooled rows, or hook
    -- their update path: doing so taints the initializer that resolves classID.
    -- Keep the stock roster layout while still skinning the column headers above.
