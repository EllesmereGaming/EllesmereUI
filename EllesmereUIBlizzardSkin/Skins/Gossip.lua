...
WSkin:AddCallback("Skin_Gossip", function()
	...
	GossipFrame.WSkin:Point(backdrop, "TOPLEFT", 11, -12)
	GossipFrame.WSkin:Point(backdrop, "BOTTOMRIGHT", -32, 0)
	...
	ItemTextFrame.WSkin:Point(backdrop, "TOPLEFT", 11, -12)
	ItemTextFrame.WSkin:Point(backdrop, "BOTTOMRIGHT", -32, 76)
