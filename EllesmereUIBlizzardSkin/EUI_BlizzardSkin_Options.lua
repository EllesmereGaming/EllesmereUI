...
initFrame:SetScript("OnEvent", function(self)
    ...
    local WINDOWS = {
        ...
        },
        {
            ...
            desc  = "Background and border for the warband currency transfer window and its log. The controls inside stay Blizzard's, so transfers keep working.",
            reloadMsg = "Changing the Currency Transfer reskin requires a UI reload to fully swap between Blizzard and Ellesmere styles.",
            setEnabled = function(v)
                if not EllesmereUIDB then EllesmereUIDB = {} end
                EllesmereUIDB.reskinCurrencyTransfer = v
            end,
        },
        {
            key   = "loot",
