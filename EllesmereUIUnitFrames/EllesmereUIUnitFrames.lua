...
local defaults = {
    profile = {
        ...
        -- Older profiles may still carry an unused `playerTarget` subtree.
        -- We no longer seed it into new profiles, and a later schema pass can
        -- remove any leftover data explicitly.
        totPet = {
            frameWidth = 101,
            healthHeight = 25,
            customBgColor = { r = 0.067, g = 0.067, b = 0.067 },
