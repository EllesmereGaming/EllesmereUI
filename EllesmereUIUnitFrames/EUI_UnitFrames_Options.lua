...
--  (the former standalone "External Defensives" tab was removed 2026-08-02
--  -- migrated into Player Aura Bars as a third built-in bar, see
--  EllesmereUIUnitFrames_PlayerAuraBars.lua's DefaultExternalDefensivesCfg)
-------------------------------------------------------------------------------
local ADDON_NAME, ns = ...
...
initFrame:SetScript("OnEvent", function(self)
    ...
    local function AttachFrameSourceCog(rgn, unitKey, opts)
        ...
        cogBtn:SetScript("OnEnter", function(self)
            self:SetAlpha(0.7)
            EllesmereUI.ShowWidgetTooltip(self, opts.cogTooltip and EllesmereUI.L(opts.cogTooltip) or "Frame Source")
        end)
    ...
    ---------------------------------------------------------------------------
    --  Player Aura Bars page (External Defensives now lives inside it, as a
