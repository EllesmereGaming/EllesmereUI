...
initFrame:SetScript("OnEvent", function(self)
    ...
    local function BuildQoLPage(pageName, parent, yOffset)
        ...
        -- Row: Target Distance Text (left, with settings cog)
        local targetDistRow
        targetDistRow, h = W:DualRow(parent, y,
        ...
        do
            local leftRgn = targetDistRow._leftRegion
            ...
            local tdCogBtn = CreateFrame("Button", nil, leftRgn)
            tdCogBtn:SetSize(26, 26)
            tdCogBtn:SetPoint("RIGHT", leftRgn._lastInline or leftRgn._control, "LEFT", -9, 0)
            leftRgn._lastInline = tdCogBtn
            tdCogBtn:SetFrameLevel(leftRgn:GetFrameLevel() + 5)
    ...
    EllesmereUI:RegisterModule("EllesmereUIQoL", {
        ...
        searchTerms = { "brez", "bres", "battle res", "combat res", "cursor", "macro", "fps", "healer", "healer mana", "logging", "combat log", "warcraft logs", "upgrade", "ilvl", "item level", "crest", "upgrade calculator", "shifter", "move", "drag", "position", "demodal", "drift", "combat alert", "enter combat", "leave combat", "in combat", "combat text", "combat notification", "transform", "transforms", "costume", "disguise", "chef's hat", "noggenfogger", "target distance", "distance to target", "range text", "yard", "yards", "movement", "mobility", "gap closer", "blink", "gateway", "warlock gateway", "control shard", "time spiral", "free movement" },
