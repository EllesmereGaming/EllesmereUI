...
do
    ...
    -- NO aura validation: stack buff 85739 is non-whitelisted, so
    -- GetPlayerAuraBySpellID returns nil even while it is visibly active, and treating
    -- that nil as "buff gone" would wipe live stacks. Prediction + the duration timer
    -- IS the tracker.
