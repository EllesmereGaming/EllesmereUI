...
L["Show Icon Divider"] = "Mostra separatore dell’icona"
L["Draw a black 1px divider between the spell icon and the cast bar."] = "Mostra un separatore nero di 1 pixel tra l’icona dell’incantesimo e la barra di lancio."
L["Keep the icon inside the cast bar footprint. When detached, the gap reduces the bar width without moving the footprint."] = "Mantiene l’icona all’interno della larghezza totale della barra di lancio. Quando è separata, lo spazio riduce la larghezza della barra senza spostare l’insieme."
L["Make Icon Part of the Bar"] = "Integra l’icona nella barra"
L["Show Icon on Right"] = "Mostra icona a destra"
L["Place the cast icon on the right side of the bar instead of the left."] = "Posiziona l’icona dell’incantesimo a destra della barra anziché a sinistra."
L["Cast Icon"] = "Icona dell’incantesimo"
L["This option requires a Border Size above 0."] = "Questa opzione richiede una dimensione del bordo maggiore di 0."
