...
L["Show Icon Divider"] = "Mostrar separador del ícono"
L["Draw a black 1px divider between the spell icon and the cast bar."] = "Muestra un separador negro de 1 píxel entre el ícono del hechizo y la barra de lanzamiento."
L["Keep the icon inside the cast bar footprint. When detached, the gap reduces the bar width without moving the footprint."] = "Mantiene el ícono dentro del ancho total de la barra de lanzamiento. Al separarlo, el espacio reduce el ancho de la barra sin desplazar el conjunto."
L["Make Icon Part of the Bar"] = "Integrar el ícono en la barra"
L["Show Icon on Right"] = "Mostrar ícono a la derecha"
L["Place the cast icon on the right side of the bar instead of the left."] = "Coloca el ícono del hechizo a la derecha de la barra en lugar de a la izquierda."
L["Cast Icon"] = "Ícono del hechizo"
