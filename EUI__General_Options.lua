...
EllesmereUI._WHATSNEW_PATCHES = {
    {
        ...
        features = {
            {
                -- The option itself lives in the Show Sort Icon row's cog
                -- popup; cog rows have no highlightable label, so the anchor
                -- is the owning row.
                module = "Bags",
            ...
            {
                -- Page-only nav: the GOLD block section header is built from
                -- a localized label, which nav section matching cannot target.
                module = "Data Bars",
    ...
    },
    {
        ...
        fixes = {
            ...
            { module = "Action Bars", text = "Fixed a bar set to Never not getting a move handle in unlock mode while the Toggle Action Bar keybind had it on screen, and a bar set to Always that the keybind had toggled off still getting one." },
