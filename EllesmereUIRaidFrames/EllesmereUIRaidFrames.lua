...
local function RefreshPreview()
    ...
    -- Container size (4 groups) -- the shared footprint formula, so the preview
    -- box matches what the live container sizes itself to for this growth pair.
