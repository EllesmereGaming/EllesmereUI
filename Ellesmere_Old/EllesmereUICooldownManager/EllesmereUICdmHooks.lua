...
--  ACTIVE_TALENT_GROUP_CHANGED and PLAYER_ENTERING_WORLD. The hot path (every
...
do
    ...
    _pccInvalidateFrame:RegisterEvent("ACTIVE_TALENT_GROUP_CHANGED")
...
function ns.SetupViewerHooks()
    ...
    do
        ...
        emEventFrame:RegisterEvent("CVAR_UPDATE")
