...
local BASELINE_EVENTS = {
    "ACTIVE_TALENT_GROUP_CHANGED", "PLAYER_TALENT_UPDATE", "GLYPH_UPDATED",
...
loader:SetScript("OnEvent", function(self, event, ...)
    ...
    if event == "ACTIVE_TALENT_GROUP_CHANGED" or event == "PLAYER_TALENT_UPDATE" or event == "GLYPH_UPDATED" then
