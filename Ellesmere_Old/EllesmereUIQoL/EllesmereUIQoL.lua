...
do
    ...
    visWatch:SetScript("OnEvent", function(_, event)
        if event == "ACTIVE_TALENT_GROUP_CHANGED" or event == "PLAYER_ENTERING_WORLD" or event == "GLYPH_UPDATED" then
            RefreshCrosshairCutoffRange()
        end
    ...
    local function SyncVisWatch(want)
        ...
        if want then
            ...
            visWatch:RegisterEvent("ACTIVE_TALENT_GROUP_CHANGED")
            visWatch:RegisterEvent("GLYPH_UPDATED")
            RefreshCrosshairCutoffRange()
        else
