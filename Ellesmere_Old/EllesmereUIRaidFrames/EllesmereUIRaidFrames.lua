...
do
    ...
    -- CVAR_UPDATE, the EditModeManagerFrame show/hide, and the
    ...
    editModeWatcher:RegisterEvent("CVAR_UPDATE")
...
function ERF:OnEnable()
    ...
    -- stale icons frozen (see the ACTIVE_TALENT_GROUP_CHANGED handler).
