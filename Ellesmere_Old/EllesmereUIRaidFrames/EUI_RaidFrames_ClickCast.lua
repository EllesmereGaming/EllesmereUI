...
-- menu -- with nothing to re-apply it afterwards (ACTIVE_TALENT_GROUP_CHANGED
...
-- ACTIVE_TALENT_GROUP_CHANGED, which reapplies.
...
function ns.CC_Init()
    ...
    ccEventFrame:RegisterEvent("ACTIVE_TALENT_GROUP_CHANGED")
