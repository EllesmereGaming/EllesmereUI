...
do
    ...
    do
        ...
        if EXEC_CLASSES[cls] then
            ...
            watcher:RegisterEvent("GLYPH_UPDATED")
...
local function EnableClassPowerWatcher()
    ...
    if type(classPowerType) == "string" then
        ...
        classPowerWatcher:RegisterEvent("ACTIVE_TALENT_GROUP_CHANGED")
...
--  ACTIVE_TALENT_GROUP_CHANGED; this early handler ensures the first
--  login is covered.
-------------------------------------------------------------------------------
do
    ...
    specLoginFrame:RegisterEvent("ACTIVE_TALENT_GROUP_CHANGED")
