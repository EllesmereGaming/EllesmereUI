...
-- Talent/loadout changes fire GLYPH_UPDATED/PLAYER_TALENT_UPDATE in a
...
local function OnEvent(self, event, ...)
    ...
    elseif event == "GROUP_ROSTER_UPDATE" then
        UpdateVisibility()
        ScheduleRosterApply()
    elseif event == "ACTIVE_TALENT_GROUP_CHANGED" or event == "ACTIVE_TALENT_GROUP_CHANGED" then
        _essenceNextTick = nil
        ...
        UpdateSecondaryResource()
        UpdateVisibility()
    elseif event == "GLYPH_UPDATED" or event == "PLAYER_TALENT_UPDATE" then
