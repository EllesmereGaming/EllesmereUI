...
-- GLYPH_UPDATED and SPELLS_CHANGED race it and read the OLD name).
...
ns.BlockFactories.spec = function(blockCfg, slot, content, barCtx)
    ...
    HookLoadoutPointer()
    inst.events = { "ACTIVE_TALENT_GROUP_CHANGED", "PLAYER_LOOT_SPEC_UPDATED",
                    -- GLYPH_UPDATED fires BEFORE the last-selected
