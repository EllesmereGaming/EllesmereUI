...
local function Refresh()
    ...
    -- (SPELLS_CHANGED, PLAYER_TALENT_UPDATE, GLYPH_UPDATED, ...) can fire
...
_B.frame:RegisterEvent("ACTIVE_TALENT_GROUP_CHANGED")
_B.frame:RegisterEvent("GLYPH_UPDATED")
...
_B.frame:SetScript("OnEvent", function(_, e, id)
    ...
    if e == "GLYPH_UPDATED" or e == "PLAYER_TALENT_UPDATE"
       or e == "SPELLS_CHANGED" or e == "ACTIVE_TALENT_GROUP_CHANGED"
...
mainFrame:RegisterEvent("GLYPH_UPDATED")
