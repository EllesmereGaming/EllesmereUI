...
initFrame:SetScript("OnEvent", function(self)
    ...
    local function BuildGeneralPage(pageName, parent, yOffset)
        ...
        do
            ...
            btn:SetScript("OnEnter", function(self)
                if friendlyPlateOff() then
                    EllesmereUI.ShowWidgetTooltip(self, EllesmereUI.L("Requires Name Only setting to be disabled"))
        ...
        do
            ...
            whiteSwatch:SetScript("OnEnter", function() EllesmereUI.ShowWidgetTooltip(whiteSwatch, EllesmereUI.L("White")) end)
            ...
            classSwatch:SetScript("OnEnter", function() EllesmereUI.ShowWidgetTooltip(classSwatch, EllesmereUI.L("Class Color")) end)
        ...
        do
            ...
            btn:SetScript("OnEnter", function(self)
                if npcOff() then
                    EllesmereUI.ShowWidgetTooltip(self, EllesmereUI.L("Requires Show Friendly NPC Nameplates to be enabled"))
                else self:SetAlpha(0.7) end
            end)
            btn:SetScript("OnLeave", function(self)
                EllesmereUI.HideWidgetTooltip()
            ...
            npcSwatch:SetScript("OnEnter", function(self)
                ...
                elseif DBVal("friendlyNameOnly") ~= false then
                    EllesmereUI.ShowWidgetTooltip(self, EllesmereUI.L("Requires Name Only mode to be disabled"))
                else
                    EllesmereUI.ShowWidgetTooltip(self, EllesmereUI.L("NPC Bar & Name Color"))
                end
            end)
        ...
        do
            ...
            eyeBtn:SetScript("OnEnter", function(self)
                self:SetAlpha(0.7)
                EllesmereUI.ShowWidgetTooltip(self, EllesmereUI.L("Show/Hide Hitbox Overlay"), { width = 175 })
            end)
    ...
    local function BuildColorsPage(pageName, parent, yOffset)
        ...
        do
            ...
            if ctrl and EllesmereUI.BuildColorSwatch then
                ...
                rightRgn._lastInline = swatch
                swatch:SetScript("OnEnter", function(s) EllesmereUI.ShowWidgetTooltip(s, EllesmereUI.L("Interrupt Ready Mid-Cast")) end)
        ...
        do
            ...
            midCastCogBtn:SetScript("OnEnter", function(s)
                s:SetAlpha(0.7)
                EllesmereUI.ShowWidgetTooltip(s, EllesmereUI.L("Cast Color Settings"))
            end)
        ...
        do
            ...
            do
                ...
                cogBtn:SetScript("OnEnter", function(self)
                    self:SetAlpha(1)
                    EllesmereUI.ShowWidgetTooltip(self, EllesmereUI.L("Pixel Glow Settings"))
                end)
                cogBtn:SetScript("OnLeave", function(self)
                    self:SetAlpha(0.4)
                    EllesmereUI.HideWidgetTooltip()
